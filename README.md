...
```bash
https://ghgo.xyz/raw.githubusercontent.com/cloudplains/iptv-api/master/output/result.m3u
```

```bash
https://ghgo.xyz/raw.githubusercontent.com/cloudplains/iptv-api/master/output/result.txt
```
